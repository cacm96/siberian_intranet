...
export class CalificationComponent implements OnInit {
  ...
  displayedColumns: string[] = ['id','equipinfras','amount','warrantyTime','serviceDetails','status','rate'];
    ...
    (
      response =>
      {
        if (response.status==true)
        {
          ...
          this.serviceOrders= this.serviceOrders.filter(serviceOrder=>{return serviceOrder.status =="finalized" || serviceOrder.status =="warranty"});
